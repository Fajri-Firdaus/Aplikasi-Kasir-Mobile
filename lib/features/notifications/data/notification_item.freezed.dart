...
mixin _$NotificationItem {
 ...
 String get id; String get title; String get message; DateTime get timestamp; NotificationType get type; bool get isRead; String? get targetRoute;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,message,timestamp,type,isRead,targetRoute);

@override
String toString() {
  return 'NotificationItem(id: $id, title: $title, message: $message, timestamp: $timestamp, type: $type, isRead: $isRead, targetRoute: $targetRoute)';
}
...
@useResult
$Res call({
 String id, String title, String message, DateTime timestamp, NotificationType type, bool isRead, String? targetRoute
});
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? message = null,Object? timestamp = null,Object? type = null,Object? isRead = null,Object? targetRoute = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String message,  DateTime timestamp,  NotificationType type,  bool isRead,  String? targetRoute)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.title,_that.message,_that.timestamp,_that.type,_that.isRead,_that.targetRoute);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String message,  DateTime timestamp,  NotificationType type,  bool isRead,  String? targetRoute)  $default,) {final _that = this;
switch (_that) {
case _NotificationItem():
return $default(_that.id,_that.title,_that.message,_that.timestamp,_that.type,_that.isRead,_that.targetRoute);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String message,  DateTime timestamp,  NotificationType type,  bool isRead,  String? targetRoute)?  $default,) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.title,_that.message,_that.timestamp,_that.type,_that.isRead,_that.targetRoute);case _:
  return null;
...
class _NotificationItem implements NotificationItem {
  const _NotificationItem({required this.id, required this.title, required this.message, required this.timestamp, this.type = NotificationType.info, this.isRead = false, this.targetRoute});
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? message = null,Object? timestamp = null,Object? type = null,Object? isRead = null,Object? targetRoute = freezed,}) {
